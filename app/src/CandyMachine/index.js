...
const CandyMachine = ({walletAddress}) => {
    ...
    const renderDropTimer = () => {
        ...
        const dropDate = new Date(
            candyMachine?.state ? candyMachine?.state.goLiveData * 1000 : ''
        );
    ...
    return (
        <div className='machine-container'>
            {renderDropTimer()}
            {/* <p>{`Drop Date: ${
                candyMachine ? candyMachine.state?.goLiveDateTimeString : ''
            }`}</p> */}
            <p>{`Items Minted: ${
                candyMachine ? candyMachine.state?.itemsRedeemed : ''
            } / ${candyMachine ? candyMachine.state?.itemsAvailable : ''}`}</p>
